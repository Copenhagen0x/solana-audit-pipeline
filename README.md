...
**Built and proven on**: [`Copenhagen0x/percolator-audit-2026-04`](https://github.com/Copenhagen0x/percolator-audit-2026-04) — independent security audit of Anatoly Yakovenko's Percolator perpetual DEX. Pipeline produced multiple findings (1 active bug, 2 code-defect-class, plus the headline **F7 residual-conservation / insurance-siphon disclosure** at [`aeyakovenko/percolator-prog#39`](https://github.com/aeyakovenko/percolator-prog/pull/39) — closed-without-merge, regression-locked on `main` at commit [`a1afd2e`](https://github.com/aeyakovenko/percolator-prog/commit/a1afd2e)), 10 formal SAFE proofs (including 2 that machine-checked the maintainer's own G3 closure statement), and re-verified 305/305 of the maintainer's existing Kani proofs against current main with zero regressions.

> **Now operationalized as [JELLEO](https://github.com/Copenhagen0x/audit-pipeline-cli)** — the underwriting layer for Solana DeFi. Four interlocking pillars on top of this methodology: **P1 counterfactual mainnet detection · P2 cross-protocol bug-class propagation · P3 closed-loop fix bundle (Kani-verified) · P4 on-chain attestation registry**. The 4-pillar architecture is an autonomous immune system that produces continuous, on-chain, cryptographically-signed attestations of code-level invariant integrity — a live signal insurance protocols, partner DeFi protocols, and STRIDE evaluators all consume. Continuous source-code monitoring, multi-agent recon, empirical PoC validation, formal verification, and live mainnet shadow detection — orchestrated end-to-end without human intervention. The 5-layer pipeline below is the foundational discovery methodology; Jelleo's 4-pillar architecture is the productized loop on top of it.
