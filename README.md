...
> **Now operationalized as [JELLEO](https://github.com/Copenhagen0x/audit-pipeline-cli)** — the autonomous immune system for Solana DeFi, built around four interlocking pillars on top of this methodology: **P1 counterfactual mainnet detection · P2 cross-protocol bug-class propagation · P3 closed-loop fix bundle (Kani-verified) · P4 on-chain attestation registry**. Continuous source-code monitoring, multi-agent recon, empirical PoC validation, formal verification, and live mainnet shadow detection — orchestrated end-to-end without human intervention. The 5-layer pipeline below is the foundational discovery methodology; Jelleo's 4-pillar architecture is the productized loop on top of it.
